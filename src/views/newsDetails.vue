<template>
  <div class="newsDetails-w">
    <div class="fixtop">
      <div class="icon" @click="$router.push('/news')">
        <img src="../assets/img/common/back.svg" alt="">
      </div>
    </div>
    <div class="wrap-two">
      <div class="goback" @click="$router.push('/news')">&lt; {{$t('news.text8')}}</div>
      <div class="title">{{newsDetails.text1}}</div>
      <div class="date">{{newsDetails.text02}}{{newsDetails.text020}}</div>
      <div class="img">
        <img :src="require('../assets/img/newPic2/news0' + cIndex + '.jpg')" alt="" v-if="cIndex < 8">
        <img :src="require('../assets/img/newPic2/news0' + cIndex + '.svg')" alt="" v-if="cIndex >= 8">
